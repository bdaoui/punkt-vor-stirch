...
const Contact = () => {
  ...
  return (
    <div className='mb-0 pb-10' id="contact">
        <h2 className='text-5xl text-center my-10'>Get in touch!</h2>
    ...
    <div className='flex flex-col md:flex-row justify-center text-center gap-20'>
            ...
            <p className='text-gray-400'>office@punkt-vor-strich.at</p>
            </div>
            ...
            <p className='text-gray-400'>+43 650/4150590</p>
            </div>
            ...
            <p className='text-gray-400'>Salmgasse 5, 1030 Wien</p>
            </div>
    </div>
