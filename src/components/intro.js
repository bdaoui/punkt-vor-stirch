...
const Intro = () => {
  return (
    <div class="h-screen">
      ...
      <div class="grid md:grid-cols-2 grid-rows-2 md:grid-rows-1 gap-8 md:px-96 h-2/4">
        <h1 class="text-4xl md:text-6xl row=span-1 md:col-span-1 m-auto p-10">
          We bring it to the <span class="underline">POINT .</span>
        </h1>

        <h1 class="text-base row=span-1 md:col-span-1 m-auto p-10 text-left">
