    ...
    <div className="flex flex-col text-center h-full md:h-screen mb-20 pb-20" id="team">
      ...
      <div className="flex flex-col md:flex-row md:gap-10  items-center mt-24 px-10 md:m-auto  ">
        ...
        <div className="overflow-hidden w-80 md:w-56  lg:w-80">
          ...
          {showSocial[0] && showSocial[1] === "Lina" && (
            <div className="relative inset-x-3 bottom-80  flex  ">
              <Link to="https://www.linkedin.com/in/lina-mosshammer/">
                <svg
              ...
              <Link to="https://twitter.com/linamoss06">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
        ...
        <div className="overflow-hidden w-80 md:w-56  lg:w-80">
          ...
          {showSocial[0] && showSocial[1] === "Claudia" && (
            <div className="relative inset-x-3 bottom-80  flex  ">
              <Link to="https://www.linkedin.com/in/claudia-falkinger/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="  text-white fill-white  w-5 absolute right-2/4 "
              ...
              <Link to="https://twitter.com/hawkinger_">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className=" fill-white  w-5 absolute  left-1/3 "
        ...
        <div className="overflow-hidden w-80 md:w-56  lg:w-80">
          ...
          {showSocial[0] && showSocial[1] === "Nadin" && (
            <div className="relative inset-x-3 bottom-80 flex ">
              <Link to="https://www.linkedin.com/in/nadinbrunnhofer/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="  text-white fill-white  w-5 absolute right-2/4 "
