...
const Team = () => {
  ...
  return (
    <div className="flex flex-col text-center h-full">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-24 px-10 md:px-96">
        <div
            ...
            <div className="relative inset-x-3 bottom-80  flex  ">
              <a href="https:linkedin.com">
                <svg
                  ...
                  viewBox="0 0 448 512"
                  className="  text-red fill-current  w-5 absolute right-2/4  "
                >
              ...
              <a href="https:twitter.com">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className=" fill-black  w-5 absolute left-1/3   "
                >
