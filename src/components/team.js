  ...
  return (
    <div flex flex-col text-center >
      ...
      <div class="flex flex-col md:flex-row justify-between items-center mt-24 px-10 md:px-96">
        ...
        <div>
            ...
            {showSocial && 
              <div class="relative inset-x-1/6 bottom-80  flex gap-2 items-center justify-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class=" fill-black  w-5 relative   ">
        ...
        <div>
            <img src={process.env.PUBLIC_URL+"/pvs_Team_Claudia_Portrait.jpg"} alt="Lina MOSSHAMMER" class="max-w-xs" />
            <h2>Claudia FALKINGER</h2>
